...
RESUME = {
    ...
    "about": {
        ...
        "vision": "I aim to bridge the gap between complex artificial intelligence research and practical, high-quality software products. My goal is to build intelligent systems that solve real problems while maintaining clean, readable, and highly optimized code bases.",
        "philosophy": [
